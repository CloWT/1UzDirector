...
public class DebitReportResult {
     ...
     */
    public DebitReportResult(String number, int reportDecriptionID, String contragent, String contract, String summa, String day30, String day60, String day90, String day100) {
        this.number = number;
