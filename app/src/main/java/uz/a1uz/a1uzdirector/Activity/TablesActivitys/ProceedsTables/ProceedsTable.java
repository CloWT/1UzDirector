...
public class ProceedsTable extends CustomActivity {
    ...
    public void cLastDay(View view) {
        switch (view.getId()) {
            case R.id.ReadyLastDay:
                activityStart(EdatePeriod.LastDay, 1);
                break;
            case R.id.OTLastDay:
                activityStart(EdatePeriod.LastDay, 2);
                break;
            case R.id.SerLastDay:
                activityStart(EdatePeriod.LastDay, 3);
                break;
            case R.id.TotalLastDay:
                activityStart(EdatePeriod.LastDay, 0);
                break;
    ...
    public void cThisWeek(View view) {
        switch (view.getId()) {
            case R.id.ReadyThisWeek:
                activityStart(EdatePeriod.ThisWeek, 1);
                break;
            case R.id.OTThisWeek:
                activityStart(EdatePeriod.ThisWeek, 2);
                break;
            case R.id.SerThisWeek:
                activityStart(EdatePeriod.ThisWeek, 3);
                break;
            case R.id.TotalThisWeek:
                activityStart(EdatePeriod.ThisWeek, 0);
                break;
    ...
    public void cLastWeek(View view) {
        switch (view.getId()) {
            case R.id.ReadyLastWeek:
                activityStart(EdatePeriod.LastWeek, 1);
                break;
            case R.id.OTLastWeek:
                activityStart(EdatePeriod.LastWeek, 2);
                break;
            case R.id.SerLastWeek:
                activityStart(EdatePeriod.LastWeek, 3);
                break;
            case R.id.TotalLastWeek:
                activityStart(EdatePeriod.LastWeek, 0);
                break;
    ...
    public void cThisMonth(View view) {
        switch (view.getId()) {
            case R.id.ReadyThisMonth:
                activityStart(EdatePeriod.ThisMonth, 1);
                break;
            case R.id.OTThisMonth:
                activityStart(EdatePeriod.ThisMonth, 2);
                break;
            case R.id.SerThisMonth:
                activityStart(EdatePeriod.ThisMonth, 3);
                break;
            case R.id.TotalThisMonth:
                activityStart(EdatePeriod.ThisMonth, 0);
                break;
    ...
    public void cLastMonth(View view) {
        switch (view.getId()) {
            case R.id.ReadyLastMonth:
                activityStart(EdatePeriod.LastMonth, 1);
                break;
            case R.id.OTLastMonth:
                activityStart(EdatePeriod.LastMonth, 2);
                break;
            case R.id.SerLastMonth:
                activityStart(EdatePeriod.LastMonth, 3);
                break;
            case R.id.TotalLastMonth:
                activityStart(EdatePeriod.LastMonth, 0);
                break;
    ...
    public void cThisyear(View view) {
        switch (view.getId()) {
            case R.id.ReadyThisYearBegin:
                activityStart(EdatePeriod.BeginYear, 1);
                break;
            case R.id.OTThisYearBegin:
                activityStart(EdatePeriod.BeginYear, 2);
                break;
            case R.id.SerThisYearBegin:
                activityStart(EdatePeriod.BeginYear, 3);
                break;
            case R.id.TotalThisYearBegin:
                activityStart(EdatePeriod.BeginYear, 0);
                break;
